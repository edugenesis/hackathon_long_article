    ...
    return (
        <DropdownMenu>
            ...
            <DropdownMenuContent>
                ...
                <DropdownMenuRadioGroup value={options().ads} onChange={(value) => updateOptions("ads", value as Options["ads"])}>
                ...
                <DropdownMenuRadioGroup value={options().embeds} onChange={(value) => updateOptions("embeds", value as Options["embeds"])}>
                    <DropdownMenuRadioItem value="disabled">Disabled</DropdownMenuRadioItem>
                    <DropdownMenuRadioItem value="enabled">Enabled</DropdownMenuRadioItem>
                    <DropdownMenuRadioItem value="optimized">Optimized</DropdownMenuRadioItem>
                </DropdownMenuRadioGroup>
